...
p_fw_l_b = [ p_bb_b.x+100, +front_frame_width/2, front_frame_bottom_z]; * joint(p_fw_l_b);
p_fw_r_b = [ p_bb_b.x+100, -front_frame_width/2, front_frame_bottom_z]; * joint(p_fw_r_b);
...
// would make mounting the front wheel impossible
